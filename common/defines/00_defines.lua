...
NProduction = {
	...
	ENERGY_COST_CAP = 4,						-- Maximum energy cost per factory
...
NAI = {
	...
	MINIMUM_MONTHLY_LEND_LEASE_EQUIPMENT = 25,	-- AI will not offer lend-lease if the monthly amount would be less than this
