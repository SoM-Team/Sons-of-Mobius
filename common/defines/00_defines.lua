...
NGame = {
	...
	HANDS_OFF_START_TAG = "XYZ",					-- tag for player country for -hands_off runs. use an existing tag that is less likely to affect the game
...
NProduction = {
	...
	RESOURCE_TO_ENERGY_COEFFICIENT = 15.0,		-- How much energy per coal produces
	BASE_COUNTRY_ENERGY_PRODUCTION = 10.0, 			-- The base energy production of a country
	ENERGY_SCALING_COST_BY_FACTORY_COUNT = 0.005, -- Scales energy cost based on the total number of factories
	BASE_ENERGY_COST = 0.2,						-- How much energy per factory consumes
	ENERGY_COST_CAP = 2,						-- Maximum energy cost per factory
	ENERGY_SCALE_PER_TRADE_FACTORY_EXPORT = 0.025, -- Factor of how many of the factories gained from trade is affects the energy cost scaling
...
NMilitary = {
	...
	GENERATE_AI_DIV_COMMAND_MEDALS = 0.5,		-- Chance for AI to award a medal when receiving a history entry that allows it. Also gives a chance for AI to gain history entries irrespective of the setting above
	MAX_NUM_AUTOMEDALS = 9999,						-- You can't get more medals from the automedal system than this.
...
NAir = {
	...
	AIR_WING_MAX_STATS_SPEED = 8800,
	AIR_WING_MAX_STATS_BOMBING = 9999,
...
NNavy = {
	...
	STRIKE_FORCE_ON_BASE_FUEL_COST_FACTOR = 0.05,					-- fuel cost for naval strike mission in port
