...
static const float GB_CAM_MAX_FILLING_CLAMP = 0.95f; // 0 to 1 value for clamping the fill when camera is at max distance, modified from vanilla  0.8;
...
static const float GB_STRENGTH_CH2 = 0.5; // Opacity of top layer, modified from vanilla  1.0;
